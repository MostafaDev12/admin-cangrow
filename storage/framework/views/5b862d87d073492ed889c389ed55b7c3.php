                                ...
                                <div class="tab-content  text-muted">
                                    <div class="tab-pane <?php echo e($gs->lang_arabic == 1 ? 'active' : ''); ?>" id="base-justified-home" role="tabpanel">
                                        <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" name="name_ar" value="<?php echo e($data->name_ar); ?>"  id="name_ar" placeholder="<?php echo e(__('translation.name')); ?>">
                                          </div>
                                    ...
                                    <div class="tab-pane <?php echo e($gs->lang_arabic == 0 ? 'active' : ''); ?>" id="base-justified-product" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" name="title_en" id="title_en" value="<?php echo e($data->title_en); ?>" placeholder="<?php echo e(__('translation.title')); ?>">
                                      </div>
                                        
                                        <div class="mb-3">
                                          <label for="name_en" class="form-label"><?php echo e(__('translation.name')); ?></label>
                                          <input type="text" class="form-control" name="name_en" id="name_en" value="<?php echo e($data->name_en); ?>" placeholder="<?php echo e(__('translation.name')); ?>">
                                      </div>
                                    ...
                                    <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" name="title_fr" id="title_fr" value="<?php echo e($data->title_fr); ?>"  placeholder="<?php echo e(__('translation.title')); ?>">
                                      </div>
                                       
                                        
                                        <div class="mb-3">
                                          <label for="name_fr" class="form-label"><?php echo e(__('translation.name')); ?></label>
                                          <input type="text" class="form-control" name="name_fr" id="name_fr" value="<?php echo e($data->name_fr); ?>"  placeholder="<?php echo e(__('translation.name')); ?>">
                                      </div>
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="type">  
                                            <option value="team" <?php echo e($data->type == 'team' ? 'selected' : ''); ?>>team</option>
                                            <option value="sales" <?php echo e($data->type == 'sales' ? 'selected' : ''); ?>>sales</option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin-cangrows\resources\views/admin/partners/edit.blade.php ENDPATH**/ ?>