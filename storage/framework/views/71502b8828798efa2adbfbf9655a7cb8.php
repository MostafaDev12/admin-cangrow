        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <?php if(Auth::guard('admin')->user()->sectionCheck('page_settings')): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link  " href="<?php echo e(route('admin-ps-our_team')); ?>" aria-controls="sidebarour_team">
                            <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.our_team_section'); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  " href="<?php echo e(route('admin-ps-after_before')); ?>" aria-controls="sidebarportfolio">
                            <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.after_before'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Auth::guard('admin')->user()->sectionCheck('models')): ?>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#models" data-bs-toggle="collapse" role="button"
                            ...
                            <i class="las la-cog"></i> <span data-key="t-General_Settings"> <?php echo app('translator')->get('translation.about_us_sections'); ?></span>
                        </a>
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  " href="<?php echo e(route('admin-models_category-index')); ?>"
                                        ...
                                        <span><?php echo app('translator')->get('translation.about_us_page_section'); ?></span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link  " href="<?php echo e(route('admin-models-index')); ?>"
                                        ...
                                        <span><?php echo app('translator')->get('translation.home_about_section'); ?></span>
                                    </a>
                                </li>
           ...
           <?php if(Auth::guard('admin')->user()->sectionCheck('blogs')): ?>
                <li class="nav-item">
                    <a class="nav-link  " href="<?php echo e(route('admin-blogs-index')); ?>" aria-controls="sidebarblogs">
