...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
        {{ __('translation.meetings') }}
        @endslot
    @endcomponent
 
          <input type="hidden" id="headerdata" value="{{ __('translation.meetings') }}">
                         <div class="col-lg-12"  >
                            <div class="card">
            ...
            <div class="top-area">
              <div class="row">
                ...
                <form  method="POST" enctype="multipart/form-data" id="form-gallery">
                  {{ csrf_field() }}
                    <input type="hidden" id="pid" name="meeting_id" value="">
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-meetings-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-meetings-create')}}">'+
