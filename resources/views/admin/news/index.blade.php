...
@section('content')
    ...
    @endcomponent
          ...
          <input type="hidden" id="headerdata" value="{{ __('translation.news') }}">
                         <div class="col-lg-12"  >
                            <div class="card">
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-news-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-news-create')}}">'+
          '<i class="fas fa-plus"></i> {{ __("translation.add_news") }}'+
          '</a>'+
          '</div>');
      });
