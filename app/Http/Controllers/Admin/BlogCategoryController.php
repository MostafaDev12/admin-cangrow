...
class BlogCategoryController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('photo', function(BlogCategory $data) {
                                $photo =  $data->photo;
    ...
    public function store(Request $request)
    {
        ...
        {              
            ...
            $file->move('assets/images/blog_categories/',$name);
        ...
        //--- Redirect Section
        $msg = 'New Data Added Successfully.<a href="'.route('admin-blog_categories-index').'">View categories Lists.</a>';
       //   return redirect(route('admin-blog_categories-index'))->with($msg);
    ...
    public function update(Request $request, $id)
    {
        ...
        {              
            ...
            if($data->photo != null)
            {
                if (file_exists(public_path().'/assets/images/blog_categories/'.$data->photo)) {
                    unlink(public_path().'/assets/images/blog_categories/'.$data->photo);
                }
            }            
        $input['photo'] = $name;
        } 
