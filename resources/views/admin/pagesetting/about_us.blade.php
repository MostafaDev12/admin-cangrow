                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" name="about_title_ar" value="{{ $ps->about_title_ar }}" id="title_ar" placeholder="{{ __('translation.title') }}">
                                              </div>
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" name="about_title_en"  value="{{ $ps->about_title_en }}"  id="title_en" placeholder="{{ __('translation.title') }}">
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" name="about_title_fr"  value="{{ $ps->about_title_fr }}"  id="title_fr" placeholder="{{ __('translation.title') }}">
                                          </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="{{$ps->about_photo ? $ps->about_photo  :  asset('assets/images/noimage.png') }}"
                                                alt="">
                                        </div>
