    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="about_us">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  " href="<?php echo e(route('admin-ps-our_factory')); ?>" aria-controls="sidebarour_factory">
                                    <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.our_factory'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " href="<?php echo e(route('admin-ps-our_business')); ?>" aria-controls="sidebarour_business">
                                    <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.our_business'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  " href="<?php echo e(route('admin-ps-catalogue')); ?>" aria-controls="sidebarcatalogue">
                                    <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.catalogue'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " href="<?php echo e(route('admin-ps-export')); ?>" aria-controls="sidebarexport">
                                    <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.export'); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " href="<?php echo e(route('admin-ps-label')); ?>" aria-controls="sidebarlabel">
                                    <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.label'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <?php if(Auth::guard('admin')->user()->sectionCheck('brunches')): ?>
                    <li class="nav-item">
                        <a class="nav-link  " href="<?php echo e(route('admin-brunches-index')); ?>"
                            aria-controls="sidebarbrunches">
                            <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.brunches'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Auth::guard('admin')->user()->sectionCheck('media')): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link  " href="<?php echo e(route('admin-image-index')); ?>"
                            aria-controls="sidebarimage">
                            <i class="las la-tachometer-alt"></i> <span><?php echo app('translator')->get('translation.gallery'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if(Auth::guard('admin')->user()->sectionCheck('models')): ?>
                     ...
                     <li class="nav-item">
                        <a class="nav-link menu-link" href="#models" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="models">
                            <i class="las la-cog"></i> <span data-key="t-General_Settings"> <?php echo app('translator')->get('translation.models'); ?></span>
                        </a>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="general">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('admin-gs-home_video')); ?>" class="nav-link" data-key="t-home_video">
...
<?php /**PATH C:\laragon\www\admin-cangrows\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>