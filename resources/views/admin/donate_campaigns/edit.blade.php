...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
        {{ __("translation.edit_donate_campaign") }}
        @endslot
    @endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-donate_campaigns-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                           ...
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_ar" class="form-label">{{ __('translation.experience') }}</label>
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_en" class="form-label">{{ __('translation.experience') }}</label>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_fr" class="form-label">{{ __('translation.experience') }}</label>
  ...
  {{--  <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id"> 
                                        ...
                                        @foreach ($parentdonate_campaigns as $cat)
