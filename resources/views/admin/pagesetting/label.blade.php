                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane active" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control ckeditor" name="label_details_ar"  id="details_ar" rows="3" placeholder="{{ __('translation.details') }}">{{ $ps->label_details_ar }}</textarea>
                                              </div>
                                        ...
                                        <div class="tab-pane " id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="label_details_en"  id="details_en" rows="3" placeholder="{{ __('translation.details') }}">{{ $ps->label_details_en }}</textarea>
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="label_details_fr"  id="details_fr" rows="3" placeholder="{{ __('translation.details') }}">{{ $ps->label_details_fr }}</textarea>
                                          </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="{{$ps->label_photo ? $ps->label_photo  :  asset('assets/images/noimage.png') }}"
                                                alt="">
                                        </div>
