...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            {{ __('translation.add_testimonial') }}
        @endslot
    @endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-testimonials-create') }}" method="POST"
    ...
    <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="job_ar"
                                                    class="form-label">{{ __('translation.job') }}</label>
                                                <input type="text" class="form-control" name="job_ar" id="job_ar"
                                                    placeholder="{{ __('translation.job') }}">
                                            </div>
    ...
    <div class="mb-3">
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                <label for="job_fr"
                                                    class="form-label">{{ __('translation.job') }}</label>
                                                <input type="text" class="form-control" name="job_fr" id="job_fr"
                                                    placeholder="{{ __('translation.job') }}">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-md-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-job mb-0"> {{ __('translation.photo') }}</h4>
                                                </div><!-- end card header -->
