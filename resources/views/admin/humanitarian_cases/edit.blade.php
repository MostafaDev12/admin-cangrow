...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-humanitarian_cases-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              {{-- <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control ckeditor" name="short_details_ar"  id="short_details_ar" rows="3" placeholder="{{ __('translation.short_details') }}">{{ $data->short_details_ar }}</textarea>
                                              </div> --}}
                                              <div class="mb-3">
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                          ...
                                          {{-- <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="short_details_en"  id="short_details_en" rows="3" placeholder="{{ __('translation.short_details') }}">{{ $data->short_details_en }}</textarea>
                                          </div>
                                           --}}
                                          <div class="mb-3">
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="short_details_fr"  id="short_details_fr" rows="3" placeholder="{{ __('translation.short_details') }}">{{ $data->short_details_fr }}</textarea>
                                          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        <label for="percent" class="form-label">{{ __('translation.percent') }}</label>
                                        <input class="form-control" type="text" name="percent"  id="percent"  value="{{ $data->percent }}"  placeholder="{{ __('translation.percent') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        <label for="total" class="form-label">{{ __('translation.total') }}</label>
                                        <input class="form-control" type="text" name="total"  id="total"  value="{{ $data->total }}" placeholder="{{ __('translation.total') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        <label for="target" class="form-label">{{ __('translation.target') }}</label>
                                        <input class="form-control" type="text" name="target"  id="target"  value="{{ $data->target }}"  placeholder="{{ __('translation.target') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
  ...
  {{--  <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="parent_id" id="parent_id"> 
                                        ...
                                        @foreach ($parenthumanitarian_cases as $cat)
