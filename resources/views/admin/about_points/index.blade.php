...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-about_points-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-about_points-create')}}">'+
          '<i class="fas fa-plus"></i> {{ __("translation.add_about_points") }}'+
          '</a>'+
          '</div>');
      });
