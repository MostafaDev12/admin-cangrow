                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control fname" name="name"
                                         placeholder="{{ __('الاسم الاول') }}" id="first" required>
                             ...
                             <div class="col-md-6">
                                 ...
                                 <input type="text" class="form-control" name="last_name"
                                     placeholder="{{ __('الاسم الاخير') }}" id="last">
                             </div>
                         </div>
                         <!--  col-md-6   -->
                 </div>
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             ...
                             <input type="" class="form-control" id="phone" name="phone"
                                 placeholder=" {{ __('رقم التليفون') }}  " required>
                         </div>
                     </div>
                     <!--  col-md-6   -->
                 </div>
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" class="form-control" id="address" name="address"
                                 placeholder=" {{ __('العنوان') }}" required>
                         </div>
                     </div>
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" class="form-control" id="area" name="area"
                                 placeholder="{{ __('المنطقة') }}" required>
                         </div>
                     </div>
                     <div class="col-md-12 ">
                         <div class="form-group">
                     ...
                     <div class="row">
                         ...
                         <div class="col-12">
                             <div class="info-item">
                                 ...
                                 <h5 class="title"> {{ __('للتواصل معنا') }}
                                 </h5>
                                 @foreach ($phones as $phone)
                                     @if ($phone)
                                         <p>
                                             <a href="tel:+2{{ $phone }}"><i class="fas fa-phone"></i>
                                                 {{ $phone }} </a>
                                         </p>
                                     @endif
                                 @endforeach
                ...
                <div class="form-maintenance wow animate__animated animate__fadeInRight " data-wow-delay="1s"
                    ...
                    <form>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="first">الاسم الاول</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="last">الاسم الاخير</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address"
                                        placeholder="المنطقه" required>
                                </div>
                            </div>
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    <label for="email">Send message</label>
                                    <textarea placeholder="Message" class="mt-2" name="" id=""></textarea>
                                </div>

                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary m-auto d-block mt-3">Submit</button>
                    </form>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-md-6">
                <div class="address text-end wow animate__animated animate__fadeInLeft" data-wow-delay="1s"
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="info-item">
                                    <img src="img/logo_2-1.webp" alt="">
                                    <h5 class="title">للتواصل معنا</h5>
                                    <p>
                                        <a href="tel:01096969781"><i class="fas fa-phone"></i> 01096969781 </a>
                                    </p>
                                    <p>
                                        <a href="mailto:info@rgs-eg.com"> <i class="fas fa-envelope"></i>
                                            info@rgs-eg.com</a>
                                    </p>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="info-item">
                                    <h5 class="title">عناوين فروعنا </h5>
                                    <p> <i class="fas fa-map-marker-alt"></i> فرع القاهرة: 10 شارع د/ سميرة موسى -
                                        بلوك
                                        16079 - الحي الخامس - مدينة العبور</p>
                                    <p> <i class="fas fa-map-marker-alt"></i> فرع الصعيد: برج رقم 9 - الدور الأول -
                                        شقة
                                        رقم 2 - أبراج الري - حدايبس برج غاز أقاليم - شارع النساجون - شارع مستشفى
                                        العام -
                                        قنا</p>
                                </div>
                            </div>
