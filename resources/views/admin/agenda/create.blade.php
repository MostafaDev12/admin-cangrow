...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-agenda-create') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="date" id="date" placeholder="{{ __('translation.date') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
