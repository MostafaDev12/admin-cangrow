...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__('translation.models')); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-models-datatables')); ?>',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="<?php echo e(route('admin-models-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__("translation.add_model")); ?>'+
          '</a>'+
          '</div>');
      });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/emocoegypt/admin.emocoegypt.com/admin/resources/views/admin/models/index.blade.php ENDPATH**/ ?>