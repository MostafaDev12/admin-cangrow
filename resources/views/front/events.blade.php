    ...
    <main>
        <section class="py-16 md:py-24">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 md:mb-24">
                    <!-- Card 1 -->
                  
                    @foreach ($servicess as $service)
                        
                    <a href="{{ route('single-events.index', ['lang' => $sign , 'slug' => $service->id ]) }}" class="rounded-lg overflow-hidden shadow-lg bg-white group">
                        <img src="{!! $service->photo !!}"
                            alt="{!! $service->{'title_' . $sign} ?? '' !!}"
                            class="w-full h-48 object- transition-transform duration-300 group-hover:scale-105">
                        <div class="p-4">
