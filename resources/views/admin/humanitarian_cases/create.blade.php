...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-humanitarian_cases-create') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="percent"  id="percent" rows="1" placeholder="{{ __('translation.percent') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="total"  id="total" rows="1" placeholder="{{ __('translation.total') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="target"  id="target" rows="1" placeholder="{{ __('translation.target') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col -->
