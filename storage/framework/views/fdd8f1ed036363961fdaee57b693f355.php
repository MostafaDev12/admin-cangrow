...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__("translation.edit_blog")); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="<?php echo e(route('admin-blogs-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 1 ? 'active' : ''); ?>" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <textarea class="form-control " name="short_details_ar"  id="short_details_ar" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_ar); ?></textarea>
                                            </div>
                                              <div class="mb-3">
                                        ...
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 0 ? 'active' : ''); ?>" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <textarea class="form-control " name="short_details_en"  id="short_details_en" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_en); ?></textarea>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                            ...
                                            <textarea class="form-control " name="short_details_fr"  id="short_details_fr" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_fr); ?></textarea>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="blog_date" id="blog_date"  value="<?php echo e($data->blog_date); ?>" placeholder="<?php echo e(__('translation.date')); ?>">
                                </div>  
                            </div> 
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="category_id" id="cat"> 
                                        ...
                                        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  data-href="<?php echo e(route('admin-subcat-load',$cat->id)); ?>"   value="<?php echo e($cat->id); ?>" <?php echo e($cat->id == $data->category_id ? 'selected' : ''); ?>><?php echo e($cat->title_ar ??  $cat->title_en); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cangrowonline/public_html/dr-shams/resources/views/admin/blogs/edit.blade.php ENDPATH**/ ?>