                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane active" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" name="volunteering_title_ar" value="{{ $ps->volunteering_title_ar }}" id="title_ar" placeholder="{{ __('translation.title') }}">
                                              </div>
                                               
                                              <div class="mb-3">
                                                  <label for="details_ar" class="form-label">{{ __('translation.details') }}</label>
                                                  <textarea class="form-control ckeditor" name="volunteering_details_ar"  id="details_ar" rows="3" placeholder="{{ __('translation.details') }}">{{ $ps->volunteering_details_ar }}</textarea>
                                              </div>
                                        ...
                                        <div class="tab-pane " id="base-justified-product" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                              ...
                                              <input type="text" class="form-control" name="volunteering_title_en"  value="{{ $ps->volunteering_title_en }}"  id="title_en" placeholder="{{ __('translation.title') }}">
                                          </div>
                                           
                                          <div class="mb-3">
                                              <label for="details_en" class="form-label">{{ __('translation.details') }}</label>
                                              <textarea class="form-control ckeditor" name="volunteering_details_en"  id="details_en" rows="3" placeholder="{{ __('translation.details') }}">{{ $ps->volunteering_details_en }}</textarea>
                                          </div>
