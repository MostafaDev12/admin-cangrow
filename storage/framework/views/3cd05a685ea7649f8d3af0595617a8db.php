...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__("translation.add_blog")); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="<?php echo e(route('admin-blogs-create')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 1 ? 'active' : ''); ?>" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                              ...
                                              <div class="mb-3">
                                                <label for="short_details_ar" class="form-label"><?php echo e(__('translation.short_details')); ?></label>
                                                <textarea class="form-control " name="short_details_ar"  id="short_details_ar" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"></textarea>
                                            </div>
                                              <div class="mb-3">
                                                  <label for="details_ar" class="form-label"><?php echo e(__('translation.details')); ?></label>
                                                  <textarea class="form-control ckeditor" name="details_ar"  id="details_ar" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"></textarea>
                                              </div>
                                             <div class="mb-3">
                                                  <label for="slug_ar" class="form-label"><?php echo e(__('translation.slug')); ?></label>
                                                  <input type="text" class="form-control" name="slug_ar" id="slug_ar"  placeholder="<?php echo e(__('translation.slug')); ?>">
                                              </div>
                                               
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_ar" class="form-label"><?php echo e(__('translation.meta_title')); ?></label>
                                                  <input type="text" class="form-control" name="meta_title_ar" id="meta_title_ar" placeholder="<?php echo e(__('translation.meta_title')); ?>">
                                              </div>
                                               
                                              <div class="mb-3">
                                                  <label for="meta_details_ar" class="form-label"><?php echo e(__('translation.meta_details')); ?></label>
                                                  <textarea class="form-control" name="meta_details_ar"  id="meta_details_ar" rows="3" placeholder="<?php echo e(__('translation.meta_details')); ?>"></textarea>
                                              </div>   
                                        </div>
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 0 ? 'active' : ''); ?>" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                            <label for="short_details_en" class="form-label"><?php echo e(__('translation.short_details')); ?></label>
                                            <textarea class="form-control " name="short_details_en"  id="short_details_en" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"></textarea>
                                        </div>
                                        
                                          <div class="mb-3">
                                              <label for="details_en" class="form-label"><?php echo e(__('translation.details')); ?></label>
                                              <textarea class="form-control ckeditor" name="details_en"  id="details_en" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"></textarea>
                                          </div>
                                          
                                          
                                           <div class="mb-3">
                                                  <label for="slug_en" class="form-label"><?php echo e(__('translation.slug')); ?></label>
                                                  <input type="text" class="form-control" name="slug_en" id="slug_en"   placeholder="<?php echo e(__('translation.slug')); ?>">
                                              </div>
                                               
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_en" class="form-label"><?php echo e(__('translation.meta_title')); ?></label>
                                                  <input type="text" class="form-control" name="meta_title_en" id="meta_title_en" placeholder="<?php echo e(__('translation.meta_title')); ?>">
                                              </div>
                                               
                                              <div class="mb-3">
                                                  <label for="meta_details_en" class="form-label"><?php echo e(__('translation.meta_details')); ?></label>
                                                  <textarea class="form-control" name="meta_details_en"  id="meta_details_en" rows="3" placeholder="<?php echo e(__('translation.meta_details')); ?>"></textarea>
                                              </div>   
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                            <label for="short_details_fr" class="form-label"><?php echo e(__('translation.short_details')); ?></label>
                                            <textarea class="form-control " name="short_details_fr"  id="short_details_fr" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"></textarea>
                                        </div>
                                          <div class="mb-3">
                                              <label for="details_fr" class="form-label"><?php echo e(__('translation.details')); ?></label>
                                              <textarea class="form-control ckeditor" name="details_fr"  id="details_fr" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"></textarea>
                                          </div>
                                          
                                          
                                           <div class="mb-3">
                                                  <label for="slug_fr" class="form-label"><?php echo e(__('translation.slug')); ?></label>
                                                  <input type="text" class="form-control" name="slug_fr" id="slug_fr" placeholder="<?php echo e(__('translation.slug')); ?>">
                                              </div>
                                               
                                           <hr>
                                            <div class="mb-3">
                                                  <label for="meta_title_fr" class="form-label"><?php echo e(__('translation.meta_title')); ?></label>
                                                  <input type="text" class="form-control" name="meta_title_fr" id="meta_title_fr" placeholder="<?php echo e(__('translation.meta_title')); ?>">
                                              </div>
                                               
                                              <div class="mb-3">
                                                  <label for="meta_details_fr" class="form-label"><?php echo e(__('translation.meta_details')); ?></label>
                                                  <textarea class="form-control" name="meta_details_fr"  id="meta_details_fr" rows="3" placeholder="<?php echo e(__('translation.meta_details')); ?>"></textarea>
                                              </div>   
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    <label for="blog_date" class="form-label"><?php echo e(__('translation.blog_date')); ?></label>
                                    <input type="date" class="form-control" name="blog_date" id="blog_date"  value="" placeholder="<?php echo e(__('translation.date')); ?>">
                                </div>  
                            </div> 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin-cangrows\resources\views/admin/blogs/create.blade.php ENDPATH**/ ?>