...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //--- Redirect Section
        $msg = 'New Data Added Successfully.<a href="'.route('admin-faqs-index').'">View category Lists.</a>';
    ...
    public function update(Request $request, $id)
    {
        ...
        //--- Redirect Section
        $msg = 'Data Updated Successfully.<a href="'.route('admin-faqs-index').'">View category Lists.</a>';
        return response()->json($msg);
        //--- Redirect Section Ends    
