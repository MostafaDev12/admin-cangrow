...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
        {{ __('translation.donate_campaigns') }}
        @endslot
    @endcomponent
 
          <input type="hidden" id="headerdata" value="{{ __('translation.donate_campaigns') }}">
                         <div class="col-lg-12"  >
                            <div class="card">
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-donate_campaigns-create')}}">'+
