...
"edit_partners" => "تعديل الشريك",
"services" => "الخدمات",
"add_service" => "إضافة خدمة",
"edit_service" => "تعديل الخدمة",
"models" => "الموديلات",
"add_model" => "إضافة موديل",
"edit_models" => "تعديل الموديل",
"logo" => "الشعار",
"content" => "المحتوى",
"role_mangment" => "إدارة الأدوار",
"staff_mangment" => "إدارة الموظفين",
"cache_clear" => "مسح الكاش",
"media" => "الوسائط",
"add_media" => "إضافة وسائط",
"edit_media" => "تعديل الوسائط",
"home_video" => "فيديو الصفحة الرئيسية",
"contact_messages" => "رسائل التواصل",
"subscriptions" => "الاشتراكات",
"social_settings" => "إعدادات التواصل الاجتماعي",
"social_media_links" => "روابط التواصل الاجتماعي",
"models_category" => "تصنيفات الموديلات",
       
       
       "home" => "الرئيسية",
"timelines" => "الجدول الزمني",
"smile_gallery" => "معرض الابتسامات",
"features" => "الميزات",
"invisalign" => "تقويم إنفزلاين",
"about_points" => "حول النقاط",
"after_befores" => "قبل وبعد",
"dental_implants" => "زراعة الأسنان",
"veneers" => "عدسات الأسنان (فينير)",
"after_and_before" => "قبل وبعد",
"small_changes" => "تغييرات بسيطة",
"doctors" => "الأطباء",
"locations" => "المواقع",
"blogs" => "المدونة",
"language" => "اللغة",
