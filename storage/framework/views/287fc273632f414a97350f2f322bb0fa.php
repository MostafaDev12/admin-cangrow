...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__("translation.add_service")); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="<?php echo e(route('admin-services-create')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                                        ...
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 1 ? 'active' : ''); ?>" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                             ...
                                             <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" name="slug_ar" id="slug_ar" required placeholder="<?php echo e(__('translation.slug')); ?>">
                                              </div>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="category_id" id="cat"> 
                                        ...
                                        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  data-href="<?php echo e(route('admin-subcat-load',$cat->id)); ?>"  value="<?php echo e($cat->id); ?>"><?php echo e($cat->title_ar ??  $cat->title_en); ?></option>
                          ...
                          <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    <label for="category_id" class="form-label"><?php echo e(__('translation.subcategories')); ?></label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin-cangrows\resources\views/admin/services/create.blade.php ENDPATH**/ ?>