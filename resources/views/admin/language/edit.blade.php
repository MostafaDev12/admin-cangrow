         ...
         <div class="container-fluid">
             ...
             <div class="row justify-content-center">
                 <div class="card">
                    ...
                    <form id="geniusform2" action="{{ route('admin-flang-update',$langg->id) }}" method="POST"  enctype="multipart/form-data"
                        >
                             {{ csrf_field() }}
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="currrent-logo" style="text-align: center;">
                                                <img style="width: 171px;" src="{{ $langg->photo }}"
                                                    alt="">
                                            </div>
                                    ...
                                    <!-- end card -->
                                     <div class="mb-4">
                                         ...
                                         <div class="input-group border rounded-1">
                                             ...
                                             <input type="text" name="language"  value="{{ $langg->language }}"  required class="form-control border-0 ps-2"
