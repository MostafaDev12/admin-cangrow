...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__('translation.model_category')); ?>

        <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>
 
          <input type="hidden" id="headerdata" value="<?php echo e(__('translation.models')); ?>">
                         <div class="col-lg-12"  >
                            <div class="card">
...
<?php $__env->startSection('script'); ?>
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-models_category-datatables')); ?>',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="<?php echo e(route('admin-models_category-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__("translation.add_model_category")); ?>'+
          '</a>'+
          '</div>');
      });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\admin-cangrows\resources\views/admin/model_categories/index.blade.php ENDPATH**/ ?>