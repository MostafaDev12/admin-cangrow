...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php echo e(__("translation.edit_slider")); ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="<?php echo e(route('admin-slider-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="<?php echo e($data->photo_ar ? $data->photo_ar  :  asset('assets/images/noimage.png')); ?>"
                                                alt="">
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">FilePond is a JavaScript library with profile picture-shaped
                                            ...
                                            upload variation.</p>
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="<?php echo e($data->photo_en ? $data->photo_en  :  asset('assets/images/noimage.png')); ?>"
                                                alt="">
                                        </div>
                                        <div class="avatar-xl mx-auto">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\admin-cangrows\resources\views/admin/slider/edit.blade.php ENDPATH**/ ?>