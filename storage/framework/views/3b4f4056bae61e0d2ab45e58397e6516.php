                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 1 ? 'active' : ''); ?>" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control ckeditor" name="short_details_ar"  id="short_details_ar" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_ar); ?></textarea>
                                              </div>
                                              <div class="mb-3">
                                        ...
                                        <div class="tab-pane <?php echo e($gs->lang_arabic == 0 ? 'active' : ''); ?>" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="short_details_en"  id="short_details_en" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_en); ?></textarea>
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control ckeditor" name="short_details_fr"  id="short_details_fr" rows="3" placeholder="<?php echo e(__('translation.short_details')); ?>"><?php echo e($data->short_details_fr); ?></textarea>
                                          </div>
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="subcategory_id" id="subcat"  > 
                                        <option value=""><?php echo e(__('translation.select')); ?></option>
                                    <?php if(optional($data->category)->subcategories): ?>
                                        <?php $__currentLoopData = $data->category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sub->id); ?>"  <?php echo e($sub->id == $data->subcategory_id ? "selected":""); ?>  ><?php echo e($sub->title_ar ??  $sub->title_en); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
