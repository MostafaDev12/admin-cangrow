...
@section('content')
    ...
    @endcomponent
          ...
          <input type="hidden" id="headerdata" value="المميزات">
                         <div class="col-lg-12"  >
                            <div class="card">
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-features-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-features-create')}}">'+
