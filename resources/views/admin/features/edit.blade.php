...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-features-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="section" id="section">
                                        <option value="home_flip" {{ $data->section == 'home_flip' ? 'selected' : '' }}>كروت الصفحة الرئيسية (فليب)</option>
                                        <option value="about_values" {{ $data->section == 'about_values' ? 'selected' : '' }}>قيم صفحة من نحن</option>
                                        <option value="about_checklist" {{ $data->section == 'about_checklist' ? 'selected' : '' }}>مميزات المنتجات - صفحة من نحن</option>
                                    </select>
                                </div>

                                <div class="mb-3">
                                    <label for="icon" class="form-label">الأيقونة</label>
                                    <input type="text" class="form-control" name="icon" id="icon" value="{{ $data->icon }}" placeholder="مثال: fas fa-handshake أو award (لوسيد)">
                                </div>
                                ...
                                <div class="tab-content  text-muted">
                                    <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                        <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                          ...
                                          <div class="mb-3">
                                              <label for="details_ar" class="form-label">التفاصيل</label>
                                              <textarea class="form-control" name="details_ar" id="details_ar" rows="5">{{ $data->details_ar }}</textarea>
                                              <small class="text-muted">لكروت الفليب: اكتب كل نقطة في سطر منفصل</small>
                                          </div>
                                    ...
                                    <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                      ...
                                      <div class="mb-3">
                                          <label for="details_en" class="form-label">التفاصيل</label>
                                          <textarea class="form-control" name="details_en" id="details_en" rows="5">{{ $data->details_en }}</textarea>
                                          <small class="text-muted">لكروت الفليب: اكتب كل نقطة في سطر منفصل</small>
                                      </div>
                                    ...
                                    <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" name="title_fr" id="title_fr" value="{{ $data->title_fr }}"  placeholder="{{ __('translation.title') }}">
                                      </div>

                                      <div class="mb-3">
                                          <label for="details_fr" class="form-label">التفاصيل</label>
                                          <textarea class="form-control" name="details_fr" id="details_fr" rows="5">{{ $data->details_fr }}</textarea>
                                          <small class="text-muted">لكروت الفليب: اكتب كل نقطة في سطر منفصل</small>
                                      </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="{{ $data->photo ?: asset('assets/images/noimage.png') }}"
                                                alt="">
                                        </div>
