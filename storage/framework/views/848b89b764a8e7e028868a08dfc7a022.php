                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="title">
                                <h1 class="wow animate__animated animate__zoomIn" data-wow-delay="1s" data-wow-duration="1s">
                                    <?php echo e($slider->{'title_' . $sign} ?? ''); ?></h1>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 col-md-6">
                        <div class="text-center wow animate__animated animate__fadeInLeft" data-wow-delay="1s"
                            data-wow-duration="1s">
                            <img width="400px" height="400px" class="m-auto" src="<?php echo e($ps->portfolio_photo); ?>"
                                alt="">
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card wow animate__animated animate__zoomIn" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo e(route('single-service.index', ['slug' => $service->{'slug_' . $sign}])); ?>"
