...
@section('content')
 ...
 <div class="col-lg-12" style=" ">
                        ...
                        <!-- Switches Color -->
                        <div class="form-check form-switch form-check-inline">
                            <input class="form-check-input" type="checkbox"  value="social_settings" role="switch" name="section[]"  id="social_settings" {{ $data->sectionCheck('social_settings') ? 'checked' : '' }}>
                            <label class="form-check-label" for="social_settings">{{ __('social_settings') }}  </label>
                        </div>
