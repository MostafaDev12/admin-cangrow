            ...
            <div class="row">
                <div class="col-12 col-lg-12 col-md-6 mb-5">
                    <div class="carousel">
                      ...
                      <?php $__currentLoopData = $service->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <img
                          class="item"
                          src="<?php echo e($gallery->photo_url); ?>"
                          alt=""
                        />
