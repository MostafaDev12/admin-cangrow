...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-features-create') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="section" id="section">
                                            <option value="home_flip">كروت الصفحة الرئيسية (فليب)</option>
                                            <option value="about_values">قيم صفحة من نحن</option>
                                            <option value="about_checklist">مميزات المنتجات - صفحة من نحن</option>
                                        </select>
                                    </div>

                                    <div class="mb-3">
                                        <label for="icon" class="form-label">الأيقونة</label>
                                        <input type="text" class="form-control" name="icon" id="icon" placeholder="مثال: fas fa-handshake أو award (لوسيد)">
                                    </div>
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control" name="details_ar" id="details_ar" rows="5"></textarea>
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="details_en" id="details_en" rows="5"></textarea>
                                              <small class="text-muted">لكروت الفليب: اكتب كل نقطة في سطر منفصل</small>
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="details_fr" id="details_fr" rows="5"></textarea>
                                              <small class="text-muted">لكروت الفليب: اكتب كل نقطة في سطر منفصل</small>
                                          </div>
