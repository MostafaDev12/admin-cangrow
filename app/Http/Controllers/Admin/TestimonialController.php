...
class TestimonialController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Testimonial $data) {
                                ...
                                <a class=" btn btn-sm btn-secondary" href="' . route('admin-testimonials-edit',$data->id) . '"> <i class="las la-edit"></i>تعديل</a>
    ...
    public function store(Request $request)
    {
      ...
      if ($file = $request->file('photo')) 
        ...
        //--- Redirect Section
        $msg = 'New Data Added Successfully.<a href="'.route('admin-testimonials-index').'">View testimonials Lists.</a>';
       //   return redirect(route('admin-testimonials-index'))->with($msg);
    ...
    public function update(Request $request, $id)
    {
      ...
      if ($file = $request->file('photo')) 
        ...
        //--- Redirect Section
        $msg = 'Data Updated Successfully.<a href="'.route('admin-testimonials-index').'">View testimonials Lists.</a>';
        return response()->json($msg);
        //--- Redirect Section Ends    
