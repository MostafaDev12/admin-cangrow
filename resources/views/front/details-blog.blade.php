 ...
 @section('css')
    ...
    <link rel="stylesheet" href="{{ asset('front/mtc/') }}/assets/css/service_details.css">
    ...
    <div class="container-body">
        ...
        <main class="content-section">
            <div class="breadcrumbs">
             {{ __('الرئيسية') }}     <span>›</span>        {{ $blog->{'title_' . $sign} }}
            </div>

            <div class="page-header">
                <h1 class="page-title">        {{ $blog->{'title_' . $sign} }}</h1>
            ...
            <div class="main-image-container">
                <img src="{{ $blog->photo }}" alt="  {{ $blog->{'title_' . $sign} }}" class="main-image">
            </div>
