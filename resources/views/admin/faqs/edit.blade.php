...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-faqs-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="mb-3">
                                    <label for="cat" class="form-label">{{ __('translation.blogs') }}</label>
                                    <select class="form-control" name="blog_id" id="cat"> 
                                        <option value="">{{ __('translation.select') }}</option>
                                        @foreach ($cats as $cat)
                                            <option  value="{{ $cat->id }}"  {{ $cat->id == $data->blog_id ? 'selected' : '' }}>{{ $cat->title_ar ??  $cat->title_en }}</option>
