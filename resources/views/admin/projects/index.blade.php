...
@section('content')
    ...
    @endcomponent
          ...
          <input type="hidden" id="headerdata" value="{{ __('translation.projects') }}">
                         <div class="col-lg-12"  >
                            <div class="card">
  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block">{{ __("Confirm Delete") }}</h4>
      ...
      <div class="modal-body">
            <p class="text-center">{{ __('You are about to delete this project.') }}</p>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-projects-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="{{route('admin-projects-create')}}">'+
          '<i class="fas fa-plus"></i> {{ __("translation.add_project") }}'+
          '</a>'+
          '</div>');
      });
