                                            ...
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" name="slug_ar" id="slug_ar"  value="{{ $data->slug_ar }}" required placeholder="{{ __('translation.slug') }}">
                                              </div>
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                           ...
                                           <div class="mb-3">
                                                  ...
                                                  <input type="text" class="form-control" name="slug_en" id="slug_en"  value="{{ $data->slug_en }}" required placeholder="{{ __('translation.slug') }}">
                                              </div>
