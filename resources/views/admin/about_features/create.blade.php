...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            {{ __('translation.add_about_feature') }}
        @endslot
    @endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-about_features-store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="type" id="type">
                                            <option value="feature">{{ __('ميزة (القسم العلوي)') }}</option>
                                            <option value="value">{{ __('قيمة (قسم القيم)') }}</option>
                                        </select>
                                    </div>
                                        ...
                                        <div class="tab-pane {{ $gs->lang_arabic == 1 ? 'active' : '' }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="title_ar"
                                                    id="title_ar" placeholder="{{ __('translation.title') }}">
                                            </div>
                                        </div>
                                        <div class="tab-pane {{ $gs->lang_arabic == 0 ? 'active' : '' }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="title_en"
                                                    id="title_en" placeholder="{{ __('translation.title') }}">
                                            </div>
                                        </div>
