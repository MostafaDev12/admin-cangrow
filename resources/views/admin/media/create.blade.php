                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="youtube_url" value="" id="youtube_url" placeholder="{{ __('translation.youtube_url') }}">
                                </div>
                            ...
                            <div class="col-xl-12 col-md-12  ">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="link" id="youtube_url" placeholder="{{ __('translation.youtube_url') }}">
                                </div>
