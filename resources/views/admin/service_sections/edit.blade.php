...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-service_sections-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="service_id" class="form-label">المنتج</label>
                                    <select name="service_id" class="form-control" id="service_id" required>
                                        @foreach ($services as $service)
                                            <option value="{{ $service->id }}" {{ $service->id == $data->service_id ? 'selected' : '' }}>{{ $service->title_ar }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="sort_order" id="sort_order" value="{{ $data->sort_order }}" placeholder="الترتيب">
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="currrent-logo" style="text-align: center;">
                                            <img style="width: 171px;" src="{{ $data->image ?: asset('assets/images/noimage.png') }}"
                                                alt="">
                                        </div>
