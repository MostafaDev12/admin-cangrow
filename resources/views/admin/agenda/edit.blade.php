...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="geniusform" action="{{route('admin-agenda-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                            ...
                                            {{--     <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="location_ar"  id="location_ar" rows="3" placeholder="{{ __('translation.location') }}">{{ $data->location_ar }}</textarea>
                                            </div>
         ...
         {{--                               
                                        <div class="mb-3">
                                          <label for="location_en" class="form-label">{{ __('translation.location') }}</label>
                                          <textarea class="form-control" name="location_en"  id="location_en" rows="3" placeholder="{{ __('translation.location') }}">{{ $data->location_en }}</textarea>
                                      </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          {{-- <div class="mb-3">
                                            <label for="location_fr" class="form-label">{{ __('translation.location') }}</label>
                                            <textarea class="form-control" name="location_fr"  id="location_fr" rows="3" placeholder="{{ __('translation.location') }}">{{ $data->location_fr }}</textarea>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="mb-3">
                                        <label for="date" class="form-label">{{ __('translation.date') }}</label>
                                          <input type="date" class="form-control" name="date" id="date" value="{{ $data->date }}" placeholder="{{ __('translation.date') }}">
                                    </div>
                                </div>
                                <!-- end card -->
                            </div> <!-- end col --> --}}
