                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="<?php if(Auth::guard('admin')->user()->photo != ''): ?> <?php echo e(URL::asset('images/' . Auth::guard('admin')->user()->photo)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?> <?php endif; ?>"
