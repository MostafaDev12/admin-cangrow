...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="geniusform" action="{{ route('admin-categories-create') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane {{$gs->lang_arabic == 1 ? 'active' : '' }}" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   {{ __('translation.arabic') }}</h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control" name="short_details_ar"  id="short_details_ar" rows="4"></textarea>
                                              </div>
                                             <div class="mb-3">
                                        ...
                                        <div class="tab-pane {{$gs->lang_arabic == 0 ? 'active' : '' }}" id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="short_details_en"  id="short_details_en" rows="4"></textarea>
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="short_details_fr"  id="short_details_fr" rows="4"></textarea>
                                          </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="icon" id="icon" placeholder="مثال: fa-solid fa-water">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="home_sort_order" id="home_sort_order" value="0">
                                        </div>
